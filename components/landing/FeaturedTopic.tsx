...
interface Props {
    ...
    title: string
    prayerPointsKey: string
    featuredImg?: string
}

export default function FeaturedTopic({ topicTrans, title, prayerPointsKey, featuredImg }: Props) {
    const { t, i18n } = useTranslation("common")
    const router = useRouter()

    const prayerPoints: string[] = topicTrans(prayerPointsKey, { returnObjects: true })
