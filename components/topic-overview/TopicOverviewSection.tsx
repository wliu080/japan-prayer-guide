                                ...
                                return (
                                    <Col key={element + idx} className="d-flex justify-content-center px-0 px-sm-1 px-md-2">
                                        <Link href={''} className="text-decoration-none position-relative">
                                            <Card className="topic-nav-card mx-1 my-3">
                                                <div className="position-relative" style={{width: 'fit-content', height: 'fit-content', borderRadius: '8px 8px 0px 0px'}}>
                                                    <Image
                                                        src={`/photos/topic-nav/${section}/placeholder.png`}
                                                        alt={""}
                                                        style={{aspectRatio: 1.772, objectFit: 'cover', width: '100%', borderRadius: '4px 4px 0px 4px'}}
                                                    />
                                                    <div style={{zIndex: 2, top: 0, cursor: 'not-allowed', backgroundColor: '#727C96', borderRadius: '10px 10px 0px 0px'}} className="position-absolute w-100 h-100 opacity-75"></div>
                                                </div>
